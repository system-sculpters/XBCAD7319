...
class UserValuationsAdapter (private val onItemClick: (Valuation) -> Unit):
    RecyclerView.Adapter<UserValuationsAdapter.ValuationViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ValuationViewHolder, position: Int) {
        ...
        holder.fullName.text = currentItem.location

        holder.email.text = currentItem.propertyType
