...
class PropertyTypeFilterAdapter (private val context: Context,
                                 private val onItemClick: (PropertyType) -> Unit) :
    RecyclerView.Adapter<PropertyTypeFilterAdapter.PropertyTypeViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PropertyTypeViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.property_type_filter_item_layout, parent, false)
