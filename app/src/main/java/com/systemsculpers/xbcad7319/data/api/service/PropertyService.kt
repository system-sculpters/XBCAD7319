...
interface PropertyService {
    ...
    @GET("property/{id}")
    fun getCategories(@Header("Authorization") token: String, @Path("id") userId: String): Call<List<Property>>
    ...
    fun createProperty(@Header("Authorization") token: String, @Body property: Property,  @Part image: MultipartBody.Part): Call<Property>
